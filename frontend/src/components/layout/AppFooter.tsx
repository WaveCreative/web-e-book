function Footer() {
  return (
    <footer className="fixed bottom-0 z-20 w-full rounded-md bg-gradient-to-b from-white/10 to-transparent backdrop-blur">
      <div className="mx-auto flex leading-normal max-w-xl flex-row gap-3 px-3 py-3 text-white md:max-w-7xl md:flex-row md:items-center md:justify-between">
        ...
        <div className="flex items-center gap-4">
          <button className="rounded-lg bg-white p-2 w-20 text-xs font-semibold text-black md:text-sm md:w-40">
            Ambil Promo
          </button>
        </div>
      </div>
